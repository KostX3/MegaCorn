...
w1 = GameSprite('assets/wall.png',win_width/2 - win_width/3, win_height/2, 300, 50)
w2 = GameSprite('assets/wall.png', 370, 100, 50, 400)
#створюємо спрайти
packman = Player('assets/ghost.png', 5, win_height - 80, 80, 80, 0, 0)
#ігровий цикл
run = True
while run:
